...
class SignIn(BasePage):
    ...
    SIGN_IN_WITH_IMDB_BUTTON = "//span[text()='Sign in with IMDb']"
    ...
    def __init__(self, driver):
        ...
        self.sign_in_with_imdb_button = self._driver.find_element(By.XPATH, self.SIGN_IN_WITH_IMDB_BUTTON)
    ...
    def sign_in_with_imdb_button_function(self):
        self.sign_in_with_imdb_button.click()
